...
class TestImport(unittest.TestCase):
	...
	def test_first_row_correct(self):
		...
		self.assertEqual(
			[2015, '2015-11-09', 100, 'por', 'den', 1, 0.5714285714285714, 0.3333333333333333, 1.7142857142857082, -6.166666666666671, 0.4503296703296703, 0.2778125928125928, 8.714285714285714, 8.666666666666668, 45.57142857142857, 45.5, -1, -2],
			self.output[0]
		)
	...
	def test_last_row_correct(self):
		...
		self.assertEqual(
			[2015, '2016-04-09', 1193, 'okc', 'sac', 1, 0.65, 0.35, 7.300000000000011, -1.4499999999999886, 0.34548591140245344, 0.34885483976095205, 10.05, 11.45, 50.85, 41.55, -1, -2],
